...
// olle_ent2 = new Room('olle_ent2', '올래입구.png') // 시장-공항 연결 (수정)
...
// 시장 입구로 이동.
// market.move4 = new MoveRoom(market, 'move4', '시장 입구 이동.png', olle_ent2) // 수정
market.move4 = new MoveRoom(market, 'move4', '시장 입구 이동.png', olle_ent1) // 수정
